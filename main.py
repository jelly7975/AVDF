...
if __name__ == '__main__':
    ...
    for fold in range(n_folds):
        ...
        model, parameters = generate_model(opt)  # model
        ...
        if opt.test:
            ...
            test_logger = Logger(os.path.join(opt.result_path, 'test' + str(fold) + '.log'),
                                 ['epoch', 'loss', 'prec1', 'prec5'])

            # model
            test_loss, test_prec1 = val_epoch('best', test_loader, model, criterion, opt, test_logger)
