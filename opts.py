...
def parse_opts():
    ...
    parser.add_argument('--annotation_path', default='preprocessing/annotations.txt', type=str, help='Annotation file path')
    parser.add_argument('--result_path', default='results_best', type=str, help='Result directory path')
    parser.add_argument('--store_name', default='model', type=str, help='Name to store checkpoints')
    parser.add_argument('--dataset', default='MHRI', type=str, help='Used dataset. Currently supporting MHRI')
    ...
    parser.add_argument('--num_heads', default=4, type=int, help='number of heads, in the paper 1 or 4')
    
    parser.add_argument('--device', default='cuda', type=str, help='Specify the device to run. Defaults to cuda, fallsback to cpu')
    
    
    parser.add_argument('--sample_size', default=224, type=int, help='Video dimensions')
    parser.add_argument('--sample_duration', default=15, type=int, help='Temporal duration of inputs')
    ...
    parser.add_argument('--batch_size', default=1, type=int, help='Batch Size')  # 128
    ...
    parser.add_argument('--pretrain_path', default='AVDF.pth.tar', type=str, help='Pretrained model (.pth)')
    ...
    parser.add_argument('--n_threads', default=0, type=int, help='Number of threads for multi-thread loading')  # 8
